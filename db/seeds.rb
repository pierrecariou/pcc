...
user1 = User.create!(email: 'ded@gmail.com', password: 'loulou39', first_name: 'Théo', last_name: 'Baptiste', pseudo: 'président', age: 24, activity: 'founder')
user2 = User.create!(email: 'fefwfw@outlook.fr', password: 'password!', first_name: 'Pierre', last_name: 'Carre', pseudo: 'STesich', age: 24, activity: 'Developper')
user3 = User.create!(email: 'grwgrw@gmail.com', password: 'sendinblue', first_name: 'Manu', last_name: 'Picard', pseudo: 'LEshark', age: 40, activity: 'Compositeur')
user4 = User.create!(email: 'fejifjifj@free.fr', password: '6H4sk46p', first_name: 'Pierre', last_name: 'Gelin')
user5 = User.create!(email: 'efewfe@hotmail.fr', password: 'kp4knAgx', first_name: 'Eugéne', last_name: 'Garnier')
user6 = User.create!(email: 'fewefefewfd@gmail.com', password: 'Iambob', first_name: 'Bob', last_name: 'Clark')
user7 = User.create!(email: 'mfemfwemf@hotmail.fr', password: '4EhMgx3W', first_name: 'Morgane', last_name: 'Millour')
user8 = User.create!(email: 'fnewfewfb@hotmail.fr', password: 'oB6ADdk9', first_name: 'Gustave', last_name: 'Bignan')
user9 = User.create!(email: 'ffbwufbew@hotmail.fr', password: 'lQw3Pl2a', first_name: 'Louis Michel', last_name: 'Liot')
user10 = User.create!(email: 'fenjefibwefbeh@gmail.com', password: 'eQmqmW93', first_name: 'Remi', last_name: 'Delacourt')
...
# puts 'Creating categories...'
 category_ecologie = Category.where(name: 'Ecologie')
 category_politique = Category.where(name: 'Politique')
 category_economie = Category.where(name: 'Economie')
 category_numerique = Category.where(name: 'Numérique')
 category_humanites = Category.where(name: 'Humanités')

# puts 'creating sub_categories'
 sub_category_energie = SubCategory.where(name: 'Energie', category: category_ecologie)
 sub_category_climat = SubCategory.where(name: 'Climat', category: category_ecologie)
 sub_category_biodiversite = SubCategory.where(name: 'Biodiversité', category: category_ecologie)
 sub_category_transition = SubCategory.where(name: 'Transition', category: category_ecologie)
 sub_category_pollution = SubCategory.where(name: 'Pollution', category: category_ecologie)
 sub_category_agriculture = SubCategory.where(name: 'Agriculture', category: category_ecologie)

 sub_category_finance = SubCategory.where(name: 'Finance', category: category_economie)
 sub_category_business = SubCategory.where(name: 'Business', category: category_economie)
 sub_category_commerce_international = SubCategory.where(name: 'Commerce International', category: category_economie)
 sub_category_inegalites = SubCategory.where(name: 'Rapports sociaux', category: category_economie)
 sub_category_economie_politique = SubCategory.where(name: 'Economie politique', category: category_economie)
 sub_category_theorie = SubCategory.where(name: 'Théories', category: category_economie)

 sub_category_politique_internationale = SubCategory.where(name: 'Politique Internationale', category: category_politique)
 sub_category_union_europeenne = SubCategory.where(name: 'Union Européenne', category: category_politique)
 sub_category_geopolitique = SubCategory.where(name: 'Géopolitique', category: category_politique)
 sub_category_vie_politique = SubCategory.where(name: 'Vie politique', category: category_politique)
 sub_category_reformes = SubCategory.where(name: 'Réformes', category: category_politique)
 sub_category_theorie = SubCategory.where(name: 'Théorie', category: category_politique)

 sub_category_intelligence_artificielle = SubCategory.where(name: 'Intelligence Artificielle', category: category_numerique)
 sub_category_gafa = SubCategory.where(name: 'GAFA/BATX', category: category_numerique)
 sub_category_startup = SubCategory.where(name: 'Startup', category: category_numerique)
 sub_category_transhumanisme = SubCategory.where(name: 'Transhumanisme', category: category_numerique)
 sub_category_technologie = SubCategory.where(name: 'Technologie', category: category_numerique)
 sub_category_futurologie = SubCategory.where(name: 'Futurologie', category: category_numerique)

 sub_category_philosophie = SubCategory.where(name: 'Philosophie', category: category_humanites)
 sub_category_histoire = SubCategory.where(name: 'Histoire', category: category_humanites)
 sub_category_art = SubCategory.where(name: 'Art', category: category_humanites)
 sub_category_societe = SubCategory.where(name: 'Société', category: category_humanites)
 sub_category_psychologie = SubCategory.where(name: 'Psychologie', category: category_humanites)
 sub_category_science = SubCategory.where(name: 'Science', category: category_humanites)
